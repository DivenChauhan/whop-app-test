        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6">
            ...
            <div className="bg-white/[0.02] border border-white/[0.05] rounded-xl p-5">
              <Typography as="p" variant="body-sm" className="!text-white italic">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-6">
            ...
            <div>
              ...
              <div className="flex gap-3 mb-3">
                <span className="flex items-center px-5 py-3 bg-white/[0.02] !text-white rounded-xl border border-white/[0.05] text-base">
                  {origin}/p/
                </span>
                <input
                  type="text"
